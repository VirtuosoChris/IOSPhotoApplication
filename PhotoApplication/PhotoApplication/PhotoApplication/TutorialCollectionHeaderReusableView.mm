...
//
//  TutorialCollectionHeaderReusableView.m
//

#import "TutorialCollectionHeaderReusableView.h"

@implementation TutorialCollectionHeaderReusableView
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (kind == UICollectionElementKindSectionHeader)
    {
        ...
        //UILabel *topics = (UILabel*)[reusableview viewWithTag:100];
        
        //_topics.font = [UIFont fontWithName:@"BIG JOHN" size:18];
    }
