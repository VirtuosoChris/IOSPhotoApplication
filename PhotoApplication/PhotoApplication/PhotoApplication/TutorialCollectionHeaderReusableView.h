...
//
//  TutorialCollectionHeaderReusableView.h
//

#import <UIKit/UIKit.h>

@interface TutorialCollectionHeaderReusableView : UICollectionReusableView
@property (weak, nonatomic) IBOutlet UILabel *topics;
